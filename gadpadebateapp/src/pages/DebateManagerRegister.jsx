...
export default function DebateManagerRegister() {
    ...
    useEffect(() => {
        fetch("http://localhost:5076/debate-manager/register-status")
            ...
            .then((data) => {
                console.log('Register status in debate manager component:', data); // Debug log
            ...
            <div className="login-container">
                <div className="login-card">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                        ...
                        <button onClick={() => navigate("/debate-manager/login")} className="login-button">
                            Go to Login
                        </button>
                    </div>
                </div>
    ...
    // If already logged in as debate manager, redirect to dashboard
    if (isDebateManager) {
        return (
            <div className="login-container">
                <div className="login-card">
    ...
    return (
        <div className="login-container">
            <div className="login-card">
                <h1 className="login-title">Debate Manager Register</h1>
                ...
                <div style={{ marginTop: "1rem", textAlign: "center" }}>
                    <p style={{ color: "#ccc", fontSize: "0.9rem" }}>
                        ...
                        <button
                            onClick={() => navigate("/debate-manager/login")}
                            style={{
                                background: "none",
                                border: "none",
                                color: "#ff6666",
